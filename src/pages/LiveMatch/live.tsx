...
import styles from '../../assets/live.module.css';
  ...
  const MobileLayout = () => (
    <div className={styles.mobileLayout}>
      ...
      <section className="px-4 pb-4">
        <div className={`max-w-md mx-auto bg-white rounded-2xl overflow-hidden ${styles.cardGlow}`}>
          <div className="bg-gradient-to-r from-purple-600 to-pink-500 px-5 py-4 text-center relative overflow-hidden">
            <div className={`absolute inset-0 ${styles.shimmer}`}></div>
          ...
          <div className="px-5 py-4 bg-gradient-to-b from-purple-50 to-white">
            <div className="relative mb-4">
              ...
              {showCopyToast && (
                <div className={`absolute -top-8 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-3 py-1.5 rounded-lg text-xs font-medium ${styles.copyToast}`}>
                  ✓ Copied!
                </div>
              )}
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/40 to-transparent">
        <a
          ...
          className={`flex items-center justify-center gap-2 w-full py-3 px-4 rounded-xl text-white font-bold text-base transition-all ${styles.whatsappBtn} ${styles.pulseAnimation}`}
        >
  ...
  const DesktopLayout = () => (
    <div className={styles.desktopLayout}>
      ...
      <section className="flex items-center justify-center">
        <div className={`bg-white rounded-3xl overflow-hidden w-full max-w-md ${styles.cardGlow}`}>
          ...
          <div className="px-8 py-6 bg-gradient-to-b from-purple-50 to-white">
            <div className="relative mb-6">
              ...
              {showCopyToast && (
                <div className={`absolute -top-10 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-4 py-2 rounded-lg text-sm font-medium ${styles.copyToast}`}>
                  ✓ Copied!
                </div>
              )}
            </div>
